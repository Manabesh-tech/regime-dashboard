...
def manual_buffer_rate_tab():
    ...
    fig.update_layout(
        ...
        xaxis_title='Final Volatility (%)',
        yaxis_title='Expected Surf Buffer',
        height=600,
        width=1000
    )
...
# Tab 2: Volatility Percentile Table
...
def volatility_percentile_tab():
    st.header("3-Hour Volatility Percentile Table")
...
# Tab 3: Automatic Buffer Rate Update
def automatic_buffer_rate_tab():
    st.header("Automatic Buffer Rate Update")
    ...
    fig = plt.figure(
        data=[plt.Scatter(
            x=df_results['50_pctile'], 
            y=df_results['init_buffer'], 
            mode='markers',
    ...
    fig.update_layout(
        ...
        xaxis_title='50th Percentile Volatility (%)',
        yaxis_title='Initial Buffer',
        height=600
    )
