...
select *from trade_pair_risk_history tprh where pair_name='PUMP/USDT' and created_at >='2025-07-24 5:15:00.000 +0800' and created_at <='2025-07-24 14:02:29.011 +0800';
//query surf volatility history
select *from  trade_pair_volatility_log where pair_name='PUMP/USDT' and created_at >='2025-07-24 5:16:00.000 +0800' and created_at <='2025-07-24 14:02:29.011 +0800';
//query rollbit buffer rate
select *from rollbit_pair_config where pair_name='1000PUMP/USDT' and created_at >='2025-08-15 01:18:00.000 +0800' and created_at <='2025-07-24 01:20:00.011 +0800';
