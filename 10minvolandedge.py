...
# Fetch all available tokens from Oracle price log tables 
@st.cache_data(ttl=60*cache_ttl, show_spinner=False)
def fetch_all_tokens():
    """Get a list of all trading pairs/tokens from oracle price logs"""
    try:
...
if token_volatility_results:
    ...
    if summary_data:
        ...
        if total > 0:
            ...
            st.warning("No volatility breakdown available - insufficient data")
